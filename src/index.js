...
import { upload } from "./multer.js";import { handleMomentCreate, handleMomentUpdate, handleMomentDelete, handleAddImagesToMoment, handleDeleteImagesFromMoment } from "./controllers/moment.controller.js";
...
//moment 수정
app.patch("/posts/moments/:momentId", handleMomentUpdate);
